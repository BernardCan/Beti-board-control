...
HD_PWD='C:/Users/Yryskul/Desktop/term_project_/term_project_2/term_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PlayController.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PlayController.tcl
